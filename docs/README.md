...
| [plans/usage-report-presentation.md](plans/usage-report-presentation.md) | Active — 1/6 reviewed; render primitives passed Round 2 after independent multi-width byte-identical baseline verification. Bar and detail semantics, stats layout, family alignment, interactive viewing, and contract text remain for `v0.4.0`. |
