...
| [plans/terminal-presentation-remediation.md](plans/terminal-presentation-remediation.md) | Active — 1/5 done. Task 1 reached fresh Reset Round R3 Review PASS, targeted tests PASS, and CEv1 VERIFIED on signed isolated-review commit `1f026a3`; Task 2 shared Detail contract freeze is next, followed by full Task 3/4 reviews, Task 5 acceptance, and the separately gated next `v0.4.0-rc.N`. |
