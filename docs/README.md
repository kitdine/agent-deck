...
| [plans/credential-and-pricing-hardening.md](plans/credential-and-pricing-hardening.md) | `v0.2.2` patch-safe hardening: credential key directory durability, price-retry ordering, and session-health documentation accuracy. Narrowed from six tasks on 2026-08-02. `active — 2/3 done`. |
