...
| [`v0.5.0` Contract Closure](topics/v0-5-0-contract/tasks.md) | `v0.5.0` | Developable — `tasks.md` has passed review; 0/2 implementation tasks are done, with `assemble` first and final contract closure second | Version-wide specification raise and documentation reconciliation after every selected topic's tasks pass review. |
